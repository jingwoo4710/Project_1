...
def main():
    ...
    app_mode = st.sidebar.selectbox("Choose the network",
        ["Yolov3", "Dectron2"])
    if app_mode == "Dectron2":
        readme_text.empty()
        run_the_dectron2()
...
def run_the_yolo():
    ...
    if image is not None:
        try:
            ...
            yolo_boxes = yolo_v3(img, confidence_threshold, overlap_threshold)
            draw_image_with_boxes(img, yolo_boxes, "Real-time Computer Vision",
